<div class="divide-y divide-gray-200" x-data="{ show: false }">
    <nav class="flex items-center bg-gray-100 px-3 py-2 shadow-lg">
        <div>
        ...
        <div class="container mx-auto sm:max-w-sm md:max-w-md lg:max-w-4xl">
            <div class="h-12 flex items-center">
                <a href="{{ url('/')}}">
                    <span class="text-4xl">🥡</span> 
                </a>
                <h1 class="text-xl font-bold font-mono uppercase ml-2">{{ config('app.name') }}</h1> 
            </div>
    ...
    <div class="sm:flex sm:min-h-screen">
        <aside class="bg-gray-100 text-gray-700 divide-y divide-gray-700 divide-dashed sm:w-4/12 md:w-3/12 lg:w-2/12">
            {{-- Desktop Web View --}}
